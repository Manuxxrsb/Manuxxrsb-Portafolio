      ...
      <nav className="navbar bg-white p-4 shadow-md fixed top-0 left-0 w-full z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <ul className="flex space-x-4 items-center space-between">
            <li className="p-2 bg-orange-500 text-white rounded-md shadow-md hover:bg-orange-600 transition duration-300 flex flex-row items-center">
              <HouseIcon size={24} />
              <Link to="/" className="ml-1">
                Home
              </Link>
            </li>
            <li className="m-4 p-2 bg-orange-500 text-white rounded-md shadow-md hover:bg-orange-600 transition duration-300 flex flex-row items-center">
              <GrProjects size={24} />
